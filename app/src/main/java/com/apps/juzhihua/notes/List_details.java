...
public class List_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                add_label_ok.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        //获取值
                        LabelDB.insertItem(new_label_text.getText().toString(),id);
                        setAdapters();
                        dialog.dismiss();
                    }
                });
        ...
        Note_title.setText(title); //设置标题
        setAdapters(); //在列表视图中显示所有的item（清单项）
        Current_Creation_Datetime.setText(NoteDB.getCreationDateTimeFromID(id));  //get creation datetime of the note
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        { //如果笔记存在收藏的标识，则更改在MenuBar上的图标，改成黄色的星星
        ...
        if(!label.equals("no"))
        {  //如果笔记中存在标签，则在MenuBar上改成ic_turned_in的图标(标签图标上画了一条线)
        ...
        { //如果清单笔记中存在提醒（闹铃）标识，则在MenuBar上改成ic_alarm_off的图标(闹铃图标上画了一条线)
            h_line.setVisibility(View.VISIBLE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.label) {  //更改标签或者创建新的标签
                ...
                label_add_btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(!TextUtils.isEmpty(label_text.getText().toString())) {
                            ...
                            Toast.makeText(List_details.this, label_text.getText().toString()+" 标签已创建", Toast.LENGTH_SHORT).show();
                            label_text.setText("");
                            FillSpinner();
                        }
                        else
                ...
                label_btn_ok.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        else
                        {
                            ...
                            Toast.makeText(List_details.this, "已添加标签 : "+sp.getSelectedItem().toString(), Toast.LENGTH_SHORT).show();
                            dialog.dismiss();
                            h_line.setVisibility(View.VISIBLE);
                            LL1.setVisibility(View.VISIBLE);
            ...
            {
                // 进入某个清单笔记详细界面后，点击了带斜线的标签图标后，则移除标签文本并且把蓝色的标签图标改成白色的标签图标
                NoteDB.AddToLabel(title, body, "no");
                h_line.setVisibility(View.INVISIBLE);
                LL1.setVisibility(View.INVISIBLE);
                mOptionsMenu.findItem(R.id.label).setIcon(R.drawable.ic_label_white);
                checkLabel = false;
                Toast.makeText(List_details.this, "笔记的标签已移除", Toast.LENGTH_SHORT).show();
            }
        }
        if (id == R.id.star) { //添加收藏或者移除收藏
            ...
            else
            {
                ...
                Toast.makeText(this, "笔记从收藏中移除", Toast.LENGTH_SHORT).show();
                mOptionsMenu.findItem(R.id.star).setIcon(R.drawable.ic_star_border_white);
                checkFavoris = false;
            }
        }
        if (id == R.id.notification) { //添加提醒，或者移除提醒
            if(checkNotification == false) {
                        ...
                        DateTime_ok.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if(!TextUtils.isEmpty(in_date.getText().toString()) && !TextUtils.isEmpty(in_time.getText().toString()))
                                {
                                    ...
                                    dialog.dismiss();
                                    mOptionsMenu.findItem(R.id.notification).setIcon(R.drawable.ic_alarm_off);
                                    Toast.makeText(List_details.this, "提醒添加成功", Toast.LENGTH_SHORT).show();
                                    checkNotification = true;
                                }
                                else {
                                    h_line.setVisibility(View.INVISIBLE);
                ...
                btn_date.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        new DatePickerDialog(List_details.this, date, myCalendar
                ...
                btn_time.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mTimePicker = new TimePickerDialog(List_details.this, new TimePickerDialog.OnTimeSetListener() {
                            @Override
        ...
        AlertDialog MyDialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确认", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        Toast.makeText(List_details.this, "笔记已删除!", Toast.LENGTH_SHORT).show();
    ...
    { // 当用户退出这个Activity时，它会把数据插入到NoteDataBase中
        super.onPause();
    ...
    public void SaveModifications()
    {
        ...
        NoteDB.UpdateData(NewTitleText,body,id);
